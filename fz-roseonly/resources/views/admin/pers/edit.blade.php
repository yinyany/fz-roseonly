...
@section('content')
    ...
    <div class="x-body">
      <form class="layui-form" action='{{ url("admin/pers/update/$Permission->id") }}' method="post">
          {{csrf_field()}}
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                   <textarea name="description" placeholder="请输入角色描述" class="layui-textarea">{{$Permission->description}}</textarea>
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>
              </div>
